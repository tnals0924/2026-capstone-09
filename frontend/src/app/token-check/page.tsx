  ...
  return (
    <main className="bg-background min-h-screen space-y-16 p-10">
      ...
      <section className="space-y-4">
        <h2 className="text-foreground text-title-2 font-bold">1. Pretendard 폰트</h2>
        <p className="text-body-1 font-thin">Thin (100) — 가나다라마바사 FlowMeet ABCabc 1234</p>
        <p className="text-body-1 font-light">Light (300) — 가나다라마바사 FlowMeet ABCabc 1234</p>
        <p className="text-body-1 font-normal">Regular (400) — 가나다라마바사 FlowMeet ABCabc 1234</p>
        <p className="text-body-1 font-medium">Medium (500) — 가나다라마바사 FlowMeet ABCabc 1234</p>
        <p className="text-body-1 font-semibold">
          SemiBold (600) — 가나다라마바사 FlowMeet ABCabc 1234
        </p>
        <p className="text-body-1 font-bold">Bold (700) — 가나다라마바사 FlowMeet ABCabc 1234</p>
        <p className="text-body-1 font-extrabold">
          ExtraBold (800) — 가나다라마바사 FlowMeet ABCabc 1234
        </p>
        <p className="text-muted-foreground text-caption-1">
      ...
      <section className="space-y-2">
        ...
        <p className="text-muted-foreground text-caption-1 mt-2">
