...
/**
 * Desktop-ratio (16:10) skeleton placeholder for feature visuals.
 * White background reserved area for real image assets.
 */
export function FeatureSkeleton() {
  return (
    <motion.div
      ...
      className="relative aspect-[16/10] w-full overflow-hidden rounded-2xl border border-white/[0.10] bg-white"
    >
      <div
